...
"""
Ejemplo de uso de un Perceptrón para implementar una compuerta lógica AND.

1. Define los datos de entrada (tabla de verdad de la compuerta AND).
...
"""
#Datos de entrenamiento: Tabla de verdad de AND
X = np.array([[0,0],
              [0,1],
              [1,0],
              [1,1]])
